...
#pragma once
#include <Windows.h>
#define OFFSET_UWORLD  0x10E500E8//
#define OFFSET_VIEWPOINT 0x10F90A10 //
...

{
    ...
    uintptr_t SkeletalMeshes = 0x56e; // 0x56b0(0x10) 
    uintptr_t PawnMaterials_ALL = 0x5A60; // 0x56c0(0x10)
    
    
    //uintptr_t CustomTimeDilation = 0x948;
